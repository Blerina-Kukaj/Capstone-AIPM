...
_CUSTOMER_FINDINGS = json.dumps({
    "findings": [
        {
            "id": "customer-001", "agent_id": "customer", "type": "insight",
            ...
            "impact": "critical", "confidence": "validated",
            "assumptions": ["Survey sample is representative"],
            "evidence": [{"source_id": "customer_notes.md", "source_type": "doc", "excerpt": "users disabled notifications"}],
            "recommendations": ["Implement ML-based priority scoring before V1 launch"],
            "tags": ["retention", "notifications"], "metadata": {},
        },
        {
            "id": "customer-002", "agent_id": "customer", "type": "opportunity",
            ...
            "impact": "high", "confidence": "directional",
            "assumptions": [], "evidence": [],
            "recommendations": ["Add per-app quiet hours to V1 scope"],
            "tags": ["feature", "power-users"], "metadata": {},
        },
        {
            "id": "customer-003", "agent_id": "customer", "type": "gap",
            ...
            "impact": "medium", "confidence": "speculative",
            "assumptions": ["Feedback UI adds <200ms latency"], "evidence": [],
            "recommendations": ["Add thumbs-up/down feedback widget in the notification shade"],
            "tags": ["ml", "feedback"], "metadata": {},
        },
        {
            "id": "customer-004", "agent_id": "customer", "type": "insight",
            ...
            "impact": "medium", "confidence": "validated",
            "assumptions": [], "evidence": [],
            "recommendations": ["Ship default quiet hours in MVP settings"],
            "tags": ["ux", "settings"], "metadata": {},
        },
    ],
...
_COMPETITIVE_FINDINGS = json.dumps({
    "findings": [
        {
            "id": "competitive-001", "agent_id": "competitive", "type": "insight",
            ...
            "tags": ["competitive", "ml"], "metadata": {},
        },
        {
            "id": "competitive-002", "agent_id": "competitive", "type": "risk",
            ...
            "impact": "critical", "confidence": "directional",
            "assumptions": ["Q2 timeline from industry sources"], "evidence": [],
            "recommendations": ["Accelerate MVP to Q1 to maintain first-mover advantage"],
            "tags": ["competitive", "timeline"], "metadata": {},
        },
        {
            "id": "competitive-003", "agent_id": "competitive", "type": "opportunity",
...
_METRICS_FINDINGS = json.dumps({
    "findings": [
        {
            "id": "metrics-001", "agent_id": "metrics", "type": "metric",
            ...
            "tags": ["north-star", "retention"], "metadata": {},
        },
        {
            "id": "metrics-002", "agent_id": "metrics", "type": "metric",
            ...
            "impact": "medium", "confidence": "directional",
            "assumptions": ["User action = open or interact"], "evidence": [],
            "recommendations": ["Track precision@3 weekly in the ML monitoring dashboard"],
            "tags": ["input-metric", "ml"], "metadata": {},
        },
        {
            "id": "metrics-003", "agent_id": "metrics", "type": "metric",
            ...
            "tags": ["guardrail", "retention"], "metadata": {},
        },
    ],
...
_REQUIREMENTS_FINDINGS = json.dumps({
    "findings": [
        {
            "id": "requirements-001", "agent_id": "requirements", "type": "requirement",
            ...
            "tags": ["performance", "ml"],
            "metadata": {
                "epic_id": "EPIC-001", "epic_title": "Intelligent Prioritization",
                "story_id": "STORY-001", "story_title": "Sub-200ms priority scoring",
                "priority": "P0", "phase": "MVP",
                "acceptance_criteria": "P95 latency < 200ms under 1k RPS load",
            },
        },
        {
            "id": "requirements-002", "agent_id": "requirements", "type": "requirement",
            ...
            "tags": ["ux", "settings"],
            "metadata": {
                "epic_id": "EPIC-002", "epic_title": "User Controls",
                "story_id": "STORY-002", "story_title": "Category-level notification toggles",
                "priority": "P1", "phase": "MVP",
                "acceptance_criteria": "Category toggle persists across app restart; applies within 1 s",
            },
        },
        {
            "id": "requirements-003", "agent_id": "requirements", "type": "requirement",
            ...
            "impact": "medium", "confidence": "directional",
            "assumptions": ["Android notification API allows custom actions"], "evidence": [],
            "recommendations": ["Implement as custom notification action button"],
            "tags": ["ml", "feedback"],
            "metadata": {
                "epic_id": "EPIC-001", "epic_title": "Intelligent Prioritization",
                "story_id": "STORY-003", "story_title": "Relevance feedback widget",
                "priority": "P2", "phase": "V1",
                "acceptance_criteria": "Feedback synced to ML training pipeline within 24 h",
            },
        },
        {
            "id": "requirements-004", "agent_id": "requirements", "type": "requirement",
            ...
            "metadata": {
                "epic_id": "EPIC-002", "epic_title": "User Controls",
                "story_id": "STORY-004", "story_title": "Per-source quiet hours",
                "priority": "P2", "phase": "V1",
...
_FEASIBILITY_FINDINGS = json.dumps({
    "findings": [
        {
            "id": "feasibility-001", "agent_id": "feasibility", "type": "constraint",
            ...
            "impact": "high", "confidence": "directional",
            "assumptions": ["ONNX runtime available on Android API 26+"], "evidence": [],
        ...
        {
            "id": "feasibility-002", "agent_id": "feasibility", "type": "insight",
            ...
            "impact": "low", "confidence": "validated",
            "assumptions": [], "evidence": [],
        ...
        {
            "id": "feasibility-003", "agent_id": "feasibility", "type": "insight",
            ...
            "impact": "medium", "confidence": "directional",
            "assumptions": ["Firestore pricing acceptable at scale"], "evidence": [],
...
_RISK_FINDINGS = json.dumps({
    "findings": [
        {
            "id": "risk-001", "agent_id": "risk", "type": "risk",
        ...
        {
            "id": "risk-002", "agent_id": "risk", "type": "risk",
            ...
            "impact": "high", "confidence": "speculative",
            "assumptions": ["Training corpus lacks language diversity data"], "evidence": [],
            "recommendations": ["Audit training data for language representation before launch"],
            "tags": ["fairness", "ml"],
            "metadata": {"category": "fairness", "is_blocker": False},
        },
        {
            "id": "risk-003", "agent_id": "risk", "type": "risk",
...
_CRITICAL_RISK_FINDINGS = json.dumps({
    "findings": [
        {
            "id": "risk-crit-001", "agent_id": "risk", "type": "risk",
        ...
        {
            "id": "risk-crit-002", "agent_id": "risk", "type": "risk",
...
async def test_e2e_sample_bundle(tmp_path: Path, mock_llm_client: MockOpenAIClient) -> None:
    ...
    findings_files = list(findings_dir.glob("findings_*.json"))
    assert len(findings_files) >= 7, (
        f"Expected ≥7 findings files, got {len(findings_files)}"
    )
    ...
    assert len(rows) >= 3, f"Expected ≥3 backlog stories, got {len(rows)}"
    ...
    required_fields = {
        ...
        "agents_run", "agents_failed", "total_findings",
        "recommendation", "artifacts", "token_usage",
    ...
    assert rec in _VALID_RECOMMENDATIONS, (
        f"recommendation '{rec}' is not one of {sorted(_VALID_RECOMMENDATIONS)}"
    )

    # ── agents and findings counts ────────────────────────────────────────
    assert len(manifest["agents_failed"]) == 0, (
        f"Unexpected agent failures: {manifest['agents_failed']}"
    )
...
async def test_e2e_prompt_mode(tmp_path: Path, mock_llm_client: MockOpenAIClient) -> None:
    ...
    prompt_text = (
        "Build a smart notification prioritization system for mobile using ML "
...
async def test_e2e_with_strict_policy(tmp_path: Path) -> None:
    ...
    strict_policy_file = (
        ...
        / "src" / "aipm" / "policies" / "strict_privacy_policy.yaml"
    )
    ...
    assert rec != "proceed", (
        f"Expected gate to block (proceed_with_mitigations or do_not_pursue) "
        f"but got '{rec}'"
    )
    ...
    assert (artifacts_dir / "decision_log.md").exists(), (
        "decision_log.md not generated after gate failure"
    )